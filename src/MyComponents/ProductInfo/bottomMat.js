...
// import bottomMatAPI from '../../API/mat.json';
...
// 	const productsArray = Object.values(bottomMatAPI);
    ...
    <div>
      <form className="flex md:space-x-4 flex-row flex-wrap md:flex-nowrap w-full justify-between md:justify-normal">
        <select
          ...
          className="flex-1 md:w-full w-[48%] border border-gray-300 rounded px-2 py-3 bg-white mb-2 md:mb-0 cursor-pointer"
        >
          <option value="">Select Color</option>
          {colorFrames.map((color, index) => (
            <option key={index} value={color}>
        ...
        <select
          ...
          className="flex-1 md:w-full w-[48%] border border-gray-300 rounded px-2 py-3 bg-white mb-2 md:mb-0"
        >
          <option value="">Select Type</option>
