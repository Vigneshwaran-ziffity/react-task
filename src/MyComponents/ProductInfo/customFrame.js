    ...
    <div>
      ...
      <div className="grid gap-4 md:grid-cols-3 grid-cols-2 py-4">
        {filteredProducts.map((product) => (
          <div
            key={product.m_sku}
            className={`border border-gray-300 items-center p-2 rounded cursor-pointer box-border 
              flex flex-row w-full hover:border-[#28A745] hover:bg-[#F0FFF4] ${activeSku === product.m_sku ? 'bg-[#E0FFE6] border-[#28A745]' : ''}`} 
